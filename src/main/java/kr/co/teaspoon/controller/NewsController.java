...
public class NewsController {
    ...
    @GetMapping("list.do")
    public String newsList(Model model) throws IOException {
        int page = 1;
        ...
        while (page < 20) {
            String NewsHomePageAddress = "https://www.hangyo.com/news/section_list_all.html?sec_no=1648&page=" + Integer.toString(page); //크롤링하고 싶은 페이지
            Document rawData = Jsoup.connect(NewsHomePageAddress).timeout(5000).get();
